...
const PRIVACY_HTML = `
<p class="subtitle">Last updated July 09, 2026</p>

<p>This Privacy Notice for Tone Chroma ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:</p>
<ul>
  <li>Download and use our mobile application, Tone Chroma, or any other application of ours that links to this Privacy Notice</li>
  <li>Engage with us in other related ways, including any marketing or events</li>
</ul>
<p><strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:tonechroma.app@gmail.com">tonechroma.app@gmail.com</a>.</p>
...
<p><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by submitting a <a href="https://app.termly.io/dsar/0a3775c4-f467-4696-a72d-064da7be9e2a" target="_blank" rel="noopener noreferrer">data subject access request</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
...
<div class="toc">
  ...
  <a href="#intltransfers">5. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</a>
...
<ul>
  ...
  <li>To protect our Services, including for fraud monitoring and prevention.</li>
...
<h2 id="intltransfers">5. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h2>
...
<p id="withdrawconsent"><strong><u>Withdrawing your consent:</u></strong> If we are relying on your consent to process your personal information, which may be express and/or implied consent depending on the applicable law, you have the right to withdraw your consent at any time. You can withdraw your consent at any time by contacting us by using the contact details provided in the section <a href="#contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a> below.</p>
...
<p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:tonechroma.app@gmail.com">tonechroma.app@gmail.com</a>.</p>
...
<p>To exercise these rights, you can contact us by submitting a <a href="https://app.termly.io/dsar/0a3775c4-f467-4696-a72d-064da7be9e2a" target="_blank" rel="noopener noreferrer">data subject access request</a>, by emailing us at <a href="mailto:tonechroma.app@gmail.com">tonechroma.app@gmail.com</a>, or by referring to the contact details at the bottom of this document.</p>
...
<h3>Appeals</h3>
<p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:tonechroma.app@gmail.com">tonechroma.app@gmail.com</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
...
<p>If you have questions or comments about this notice, you may email us at <a href="mailto:tonechroma.app@gmail.com">tonechroma.app@gmail.com</a>.</p>

<h2 id="request">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
<p>Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please fill out and submit a <a href="https://app.termly.io/dsar/0a3775c4-f467-4696-a72d-064da7be9e2a" target="_blank" rel="noopener noreferrer">data subject access request</a>.</p>
...
export default function Privacy() {
  return (
    <div className="min-h-screen bg-[#08091a] text-slate-100">
      <SiteHeader />
      <style>{`
        .privacy-content {
          color: #cbd5e1;
        ...
        .privacy-content h2 { font-size: 19px; margin-top: 2em; color: #f1f5f9; font-weight: 500; }
        .privacy-content h3 { font-size: 16px; color: #f1f5f9; font-weight: 500; }
        .privacy-content .subtitle { color: #94a3b8; font-size: 14px; margin-bottom: 2em; }
        .privacy-content a { color: #a78bfa; }
        .privacy-content a:hover { color: #c4b5fd; }
        .privacy-content strong { color: #f1f5f9; }
        .privacy-content table { width: 100%; border-collapse: collapse; margin: 1em 0; }
        .privacy-content th, .privacy-content td { border: 1px solid rgba(255,255,255,0.1); padding: 8px; text-align: left; vertical-align: top; }
        .privacy-content .toc a { display: block; margin-bottom: 4px; }
        .privacy-content ul { list-style: disc; padding-left: 1.5em; margin: 1em 0; }
        .privacy-content ol { list-style: decimal; padding-left: 1.5em; margin: 1em 0; }
        .privacy-content li { margin-bottom: 0.4em; }
        .privacy-content p { margin: 1em 0; }
        .privacy-content hr { border-color: rgba(255,255,255,0.1); margin: 2em 0; }
      `}</style>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 text-lg leading-relaxed max-w-xl mx-auto">
              How Tone Chroma handles your personal information across our
              app and website.
            </p>
          </div>

          <div className="rounded-3xl bg-gradient-to-br from-white/[0.03] to-white/[0.01] border border-white/[0.06] p-8 sm:p-12">
            <div
